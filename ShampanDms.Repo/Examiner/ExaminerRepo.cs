    ...
    public class ExaminerRepo
    {
        public ResultVM List(CommonVM model)
        {
            try
            {
                ...
                #region Invoke API
                var data = httpRequestHelper.PostData("api/Examiner/QuestionAnsList", authModel, JsonConvert.SerializeObject(model));
        ...
        public ResultVM Insert(List<QuestionVM> Answers)
        {
            try
            {
                ...
                #region Invoke API
                var data = httpRequestHelper.PostData("api/Examiner/Insert", authModel, JsonConvert.SerializeObject(Answers));
                ResultVM result = JsonConvert.DeserializeObject<ResultVM>(data);
                #endregion
        ...
        public ResultVM ExamSubmit(QuestionVM Answers)
        {
            try
            {
                ...
                #region Invoke API
                var data = httpRequestHelper.PostData("api/Examiner/ExamSubmit", authModel, JsonConvert.SerializeObject(Answers));
                ResultVM result = JsonConvert.DeserializeObject<ResultVM>(data);
                #endregion
